function [lambdas, eigenVectors,residualImage] = dtiLeastSquaresW2m(bImages, bMatrices,mask)
%--------------------------------------------------------------------------
...
% --mask                       = Possibility of specifying a mask. Speeds
%                                up the computation.
%
% OUTPUTS:
