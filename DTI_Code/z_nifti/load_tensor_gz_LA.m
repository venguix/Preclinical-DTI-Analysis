...
%
function [nii] = load_tensor_gz_LA(filename, img_idx, old_RGB)
   
%ajout pour gz - Luis Akakpo
parts=strsplit(filename,'.gz');
if strcmp(parts{end},'')
   ...
   %
   [nii.img,nii.hdr] = ...
	load_tensor_img_LA(nii.hdr,nii.filetype,nii.fileprefix,nii.machine,img_idx,old_RGB);
